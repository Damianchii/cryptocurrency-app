	...
	return (
		<div className='w-full h-full flex justify-center items-center font-main'>
			<div className='flex flex-col items-center w-full max-container p-4 border-[1.5px] border-purple-500 rounded-xl text-white'>
				<h1 className='lg:text-5xl text-3xl flex justify-center items-center font-[600] py-4 px-2'>
					{coin.name && coin.name}
				</h1>
				<div className='flex relative p-4  w-full border-b border-purple-500 '>
					<h2 className='absolute max-lg:top-[-20px] top-0 left-0  lg:px-4 px-2 py-[2px] lg:py-2 font-[300] rounded-xl bg-gradient-to-r from-[#00CCF2] via-[#845FFA] to-[#F964D6]'>
					...
					<div className='flex gap-2 items-center justify-center flex-1 p-4'>
						...
						<p className='lg:text-2xl text-xl font-[500]'>{coin.name}</p>
						<p className='text-slate-500 font-[400]'>{coin.symbol && coin.symbol.toUpperCase()}/USD</p>
					</div>
					<div className='flex items-center justify-center flex-1 lg:text-3xl text-2xl font-[600] font-stock tracking-wider'>
						...
						<span
							className={`${
								coin.market_data && coin.market_data.market_cap_change_percentage_24h < 0
									? 'text-red-500'
									: 'text-green-500'
							} px-2 text-sm lg:text-xl`}>
							{coin.market_data && coin.market_data.market_cap_change_percentage_24h.toFixed(2)}%
						</span>
					</div>
				</div>
				<div className='grid grid-rows-2 grid-flow-col p-4 mt-2 lg:mt-6 w-full lg:w-[600px]'>
				...
				<div className='flex gap-10 justify-between p-4 lg:mt-4 mt-2 lg:text-2xl text-xl'>
					<div className=''>
						Market value{' '}
				...
				<div className='lg:py-6 mt-6 py-2 lg:mt-10 px-4'>
